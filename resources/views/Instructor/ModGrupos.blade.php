                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group md-4">
                                    <select class="form-control" id="gru_dia" value="{{$grupo->gru_dia}}" name="gru_dia">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-group md-4">
                                    <select class="form-control" id="dis_id" value="{{$grupo->dis_id}}"  name="dis_id">
                ...
                <!-- Inicia Campo Horario -->
                                ...
                                <div class="container">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-5">
                                                <div class="input-group md-4">
                                                    <select class="form-control" id="aul_id" name="aul_id">
                                        ...
                                        <div class="col-auto">
                                            <select class="form-control" value="" id="gru_hora" name="gru_hora" required>
                                        ...
                                        <div class="col-auto">
                                            <input class="form-control" id="gru_min" value="" placeholder="Min" type="number" max="59" min="00" name="gru_min" required>
                                        </div>
